...
@Component({
  selector: 'ngx-consultation-times',
  templateUrl: './consultation-times.component.html',
  styleUrls: ['./consultation-times.component.scss']
})
export class ConsultationTimesComponent implements OnInit {
